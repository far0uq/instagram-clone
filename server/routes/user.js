...
router.post("/token-validation", userController.tokenValidation);
router.post("/profile-image-upload", userController.profileImageUpload);
...
router.get("/fetch-user-id", userController.fetchUserId);
